...
metadata_batch_id = TermsFacet(field = "metadata.batch_id")



metadata_warnings = TermsFacet(field = "metadata.warnings")



metadata_errors = TermsFacet(field = "metadata.errors")
