...
metadata_harvester_id = TermsFacet(field = "metadata.harvester_id")



metadata_started = TermsFacet(field = "metadata.started")



metadata_finished = TermsFacet(field = "metadata.finished")
...
metadata_status = TermsFacet(field = "metadata.status")



metadata_exception_keyword = TermsFacet(field = "metadata.exception.keyword")
