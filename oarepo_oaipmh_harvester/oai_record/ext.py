...
class Oai_recordExt:
    ...
    def service_records(self):
        return config.OAI_RECORD_RECORD_SERVICE_CLASS(
            config=config.OAI_RECORD_RECORD_SERVICE_CONFIG(),
        )

    @cached_property
    def resource_records(self):
        return config.OAI_RECORD_RECORD_RESOURCE_CLASS(
            service=self.service_records,
            config=config.OAI_RECORD_RECORD_RESOURCE_CONFIG(),
        )
